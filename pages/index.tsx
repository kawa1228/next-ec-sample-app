  ...
  return (
    <div className="app">
      <Head>
        ...
        <script src="https://cdn.snipcart.com/scripts/2.0/snipcart.js" data-api-key="NmVlNTZiMGMtNGY3ZC00MjM5LWJhYmQtOWQ5ZGFjNjYzYzkxNjM3MTExMDI0ODI4NTkyODI2" id="snipcart"></script>
